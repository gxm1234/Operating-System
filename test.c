...
void test3(void) {
	...
	if (DataRead == 0)
		aprintf("Something screwed up allocating space in test3\n");
...
void test6(void) {
	...
	GET_PROCESS_ID("", &OurProcessID, &ErrorReturned);
	aprintf("Test 6: Pid %ld, Release %s\n", OurProcessID, CURRENT_REL);
