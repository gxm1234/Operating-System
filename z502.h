...
typedef struct {
    ...
    INT32               DiskReads[MAX_NUMBER_OF_DISKS];
    INT32               DiskWrites[MAX_NUMBER_OF_DISKS];
    INT32               DiskBusyTime[MAX_NUMBER_OF_DISKS];
    INT32               NumberChargeTimes;
    INT32               NumberOfFaults;
    INT32               NumberOfSystemCalls;
} HARDWARE_STATS;
